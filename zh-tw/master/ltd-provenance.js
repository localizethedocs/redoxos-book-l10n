...
function createProvenanceDropdown() {
  ...
  const upstreamOwner = "the Redox OS nonprofit" !== "" ? "the Redox OS nonprofit" : "the upstream owner";
  const upstreamDocs  = "https://doc.redox-os.org/book";
  const upstreamRepo  = "https://gitlab.redox-os.org/redox-os/book";
